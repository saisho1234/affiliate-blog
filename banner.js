...
(function () {
  ...
  let idx = 0;
  if (path.includes('plaud') || path.includes('ic-recorder')) idx = 4; // PLAUD NOTE
  else if (path.includes('notta') || path.includes('transcri') || path.includes('memo') || path.includes('voice') || path.includes('record') || path.includes('zenchord')) idx = 1; // Notta
